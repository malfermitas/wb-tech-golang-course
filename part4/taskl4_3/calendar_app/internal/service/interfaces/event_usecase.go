...
type EventUsecase interface {
	CreateEvent(userID, title, description, dateStr, reminderTimeStr string) (*entity.Event, error)
	UpdateEvent(eventID, userID, title, description, dateStr, reminderTimeStr string) (*entity.Event, error)

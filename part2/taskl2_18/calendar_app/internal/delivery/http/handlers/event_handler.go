...
import (
	...
	"calendar_app/internal/usecase/interfaces"
	"encoding/json"
	"net/http"
)
...
func (h *EventHandler) CreateEvent(w http.ResponseWriter, r *http.Request) {
	...
	event, err := h.eventUsecase.CreateEvent(req.UserID, req.Event, req.Description, req.Date)
	if err != nil {
...
func (h *EventHandler) UpdateEvent(w http.ResponseWriter, r *http.Request) {
	...
	event, err := h.eventUsecase.UpdateEvent(req.EventID, req.UserID, req.Event, req.Description, req.Date)
	if err != nil {
		writeError(w, http.StatusServiceUnavailable, err.Error())
		return
	}
